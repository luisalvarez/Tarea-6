<?php
	...
	{
		$rs = "<div class='ui-state-highlight ui-corner-all quitameAlPaso' style='padding: 0pt 0.7em; '><p><span class='ui-icon ui-icon-info' style='float: left; margin-right: 0.3em;'/>$mensaje</p></div>";
		return $rs;
	}
	
	function mensajeDeError($mensaje)
	{
		$rs = "<div class='ui-state-error  ui-corner-all quitameAlPaso' style='padding: 0pt 0.7em; '><p><span class='ui-icon ui-icon-alert' style='float: left; margin-right: 0.3em;'/>$mensaje</p></div>";
		return $rs;
	}
